...
struct TORCH_CUDA_CPP_API CUDAGraph {
  ...
  void capture_begin(MempoolId_t pool={0, 0}, hipStreamCaptureMode capture_mode = hipStreamCaptureModeGlobal);
  void capture_end();
  void replay();
  void reset();
  MempoolId_t pool();
  ...
  // uuid used to request a particular private mempool from HIPCachingAllocator.
